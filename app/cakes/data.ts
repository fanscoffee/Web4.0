...
export const cakesProducts: Product[] = [
  {
    ...
    image: '/tartas-enteras/tres_leches_P.webp',
  ...
  },
  {
    ...
    description:
    'Bizcocho esponjoso bañado con leche condensada, evaporada y nata.',
    image: '/tartas-enteras/tres_leches_M.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 35.0,
    portions: 8,
    rating: 3,
  ...
  },
  {
    ...
    description:
    'Bizcocho esponjoso bañado con leche condensada, evaporada y nata.',
    image: '/tartas-enteras/tresleches_G.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 47.0,
    portions: 12,
    rating: 3,
  ...
  },
  {
    ...
    image: '/tartas-enteras/Tarta_de_queso.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 15.0,
    portions: 4,
    rating: 2,
  ...
  },
  {
    ...
    image: '/tartas-enteras/Pie_de_limón.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 12.0,
    portions: 4,
    rating: 1,
  ...
  },
  {
    ...
    image: '/tartas-enteras/Tarta_red_velvet.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 40.0,
    portions: 10,
    category: 'Especial'
  },
  {
    ...
    image: '/tartas-enteras/tarta_de_chocolate.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 40.0,
    portions: 10,
    category: 'Chocolate'
  },
  {
    ...
    image: '/tartas-enteras/Tarta_de_piña.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 35.0,
    portions: 8,
    category: 'Frutas'
  },
  {
    ...
    image: '/tartas-enteras/Tarta_Lotus.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 28.0,
    portions: 4,
    category: 'Especial'
  },
  {
    ...
    image: '/tartas-enteras/Quesillo.webp',
  ...
  },
  {
    ...
    description: 'Carrot cake con especias, nueces y frosting de queso crema.',
    image: '/tartas-enteras/Tarta_zanahoria.webp',
  ...
  },
  {
    ...
    image: '/tartas-enteras/Pie_maracuyá.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 12.0,
    portions: 4,
    category: 'Cítricos'
  ...
  },
  {
    ...
    image: '/tartas-enteras/Tarta_sacher.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 40.0,
    portions: 10,
    category: 'Chocolate'
  ...
  },
  {
    ...
    image: '/tartas-enteras/Tarta_chocolate.webp',
    allergens: { gluten: true, lactose: true, egg: true, nuts: false },
    price: 40.0,
    portions: 10,
    category: 'Chocolate'
