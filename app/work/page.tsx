...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.fanscoffee.es/work'
  },
  openGraph: {
    title: 'Trabaja con Nosotros | Fans Coffee Bakery',
    description:
      'Únete a nuestro equipo. Personas apasionadas por la panadería y el café.',
...
export default function Work() {
  return (
    <main className='brand-page brand-prose'>
      <p className='brand-eyebrow'>Forma parte de FANS</p>
      ...
      <p className='my-7 mt-5 font-bold'>¡Bienvenido/a a nuestro equipo!</p>
      <a
